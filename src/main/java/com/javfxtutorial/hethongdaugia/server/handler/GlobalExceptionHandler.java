...
public class GlobalExceptionHandler implements Thread.UncaughtExceptionHandler {
  ...
  public void uncaughtException(Thread thread, Throwable throwable) {
    ...
    log.error(
        "Thread: {} (ID: {}, State: {})", thread.getName(), thread.getId(), thread.getState());
  ...
  private void handleByType(Throwable t) {
    ...
    // ========== 2. LỖI ĐẤU GIÁ ==========
      ...
      log.warn("BID-004 - Giá đấu vượt quá giới hạn: {}", t.getMessage());
        ...
        instanceof com.javfxtutorial.hethongdaugia.common.Exception.bid.BidConflictException) {
    ...
    // ========== 11. FALLBACK - BẮT TẤT CẢ NHỮNG GÌ CÒN LẠI ==========
      ...
      log.error(
          "UNCAUGHT - Lỗi chưa được phân loại: {} - {}", t.getClass().getName(), t.getMessage(), t);
    }
  }
  ...
  private void logMemoryStatus() {
    ...
    log.info(
        "MEMORY - Max: {}MB, Used: {}MB, Free: {}MB, Usage: {}%",
        max / (1024 * 1024), used / (1024 * 1024), free / (1024 * 1024), (used * 100) / max);
  }
