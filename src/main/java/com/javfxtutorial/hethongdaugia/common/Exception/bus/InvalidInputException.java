...
/**
 * Ngoại lệ được ném ra khi dữ liệu đầu vào không hợp lệ.
 * Xảy ra khi:
 *   Trường dữ liệu bị null hoặc rỗng
...
public class InvalidInputException extends BusinessException {
    ...
    public InvalidInputException(String fieldName, String invalidValue, String reason) {
        super(ErrorCode.BIZ_INVALID_INPUT,
            String.format("Trường '%s' với giá trị '%s' không hợp lệ: %s",
