...
public class GlobalExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void handleException(Throwable throwable) {
        ...
        if (throwable instanceof ConnectionTimeoutException) {
            ...
            showErrorAlert(
                    ...
                    String.format(
                            "Kết nối đến %s bị timeout sau %d giây.\nVui lòng kiểm tra mạng và thử lại.",
        ...
        // ========== 3. LỖI ĐẤU GIÁ  ==========
            ...
            LowerThanCurrentBidException e = (LowerThanCurrentBidException) throwable;
            showErrorAlert(
                    "Giá đặt không hợp lệ",
                    "Giá đặt phải cao hơn giá hiện tại",
                    String.format("Giá hiện tại: %,.0f VND", e.getCurrentPrice()),
                    "Vui lòng đặt giá cao hơn");
        } else if (throwable instanceof InsufficientIncrementException) {
            InsufficientIncrementException e = (InsufficientIncrementException) throwable;
            showErrorAlert(
                    "Bước giá không đủ",
    ...
    public boolean showConfirmAlert(
            String title, String header, String content, String confirmText) {
    ...
    /**
     * Đăng ký global exception handler cho client Gọi phương thức này ngay khi khởi động ứng dụng
     */
