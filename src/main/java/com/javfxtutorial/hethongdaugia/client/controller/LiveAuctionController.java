...
public class LiveAuctionController implements ResponseListener {
  ...
  @FXML
  private TextField priceInput_tf;
  @FXML
  private Label highestPayer_tf;
  @FXML
  private Label currentPrice_tf;
  @FXML
  private Label stepPrice_tf;
  @FXML
  ...
  @FXML
  private ListView<BidTransaction> bidHistory;
  @FXML
  private TextField autoMaxPrice_tf; // Ô nhập giá trần
  @FXML
  private ToggleButton autoBidToggle; // Nút bật/tắt chế độ tự động
    ...
    timer.setOnFinished(() -> {
      ...
      Platform.runLater(() -> {
        try {
          ...
          ServerConnection connection = NetworkManager.getConnection();
          Command cmd2 = new UpdateAuctionStatusCommand(currentAuction);
          connection.sendCommand(cmd2);
