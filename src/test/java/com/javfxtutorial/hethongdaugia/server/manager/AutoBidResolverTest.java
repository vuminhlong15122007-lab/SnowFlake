...
class AutoBidResolverTest {
  ...
  private AutoBidResult runAutoBid(Auction auction, List<AutoBidConfig> configs) throws Exception {
    ...
    return new AutoBidResult(auctionDAO, bidDAO, bidCaptor.getAllValues(), listener.receivedBids);
  }
  ...
  private AutoBidConfig bot(
      int userId, String userName, String maxPrice, boolean active, LocalDateTime registeredAt) {
